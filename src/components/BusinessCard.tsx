...
export function BusinessCard({ business, inCarousel = false }: BusinessCardProps) {
    ...
    return (
        <Link
            ...
            className={`${inCarousel ? 'w-[280px] md:w-[301px]' : 'w-full md:w-[301px]'} group bg-surface border border-app rounded-2xl overflow-hidden hover:border-accent/50 transition-all duration-500 hover:shadow-lg hover:shadow-accent/20 flex flex-col h-[350px] shrink-0`}
        >
            {/* Cover Image */}
