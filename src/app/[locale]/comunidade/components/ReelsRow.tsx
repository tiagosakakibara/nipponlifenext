...
export function ReelsRow({ reels }: ReelsRowProps) {
    ...
    return (
        <>
            ...
            <div
                ref={scrollRef}
                className="flex lg:grid lg:grid-cols-5 gap-4 overflow-x-auto lg:overflow-visible pb-8 scrollbar-hide"
            ...
            >
                {reels.map((reel) => (
                    <button
                        ...
                        className="relative flex-shrink-0 lg:flex-shrink w-[180px] lg:w-full h-[320px] rounded-2xl overflow-hidden group cursor-pointer focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 hover-lift shadow-lg transition-all duration-500"
