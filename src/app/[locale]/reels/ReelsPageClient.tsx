...
import ReelsAccessButton from '@/app/[locale]/comunidade/ReelsAccessButton';
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    <div className="max-w-3xl mx-auto space-y-4">
                        ...
                        <p className="text-lg text-secondary font-medium max-w-xl mx-auto">
                            Explore os melhores momentos compartilhados pela nossa comunidade.
                        </p>
            ...
            <section className="container mx-auto px-6 py-12">
                {reels.length === 0 ? (
                    <div className="text-center py-20 bg-surface rounded-2xl border border-app">
                        ...
                        <h3 className="text-lg font-medium text-primary">Nenhum reel encontrado</h3>
                        <p className="text-muted text-sm mt-2">Seja o primeiro a compartilhar um vídeo com a comunidade!</p>
                    </div>
                ) : (
