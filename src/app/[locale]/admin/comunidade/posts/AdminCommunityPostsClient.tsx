    ...
    return (
        <div className="space-y-8 animate-fade-in pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 className="text-4xl font-black text-[#1a1a1a] tracking-tight">Community Feed</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    <div key={i} className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-sm flex items-center justify-between group hover:border-[#5593C3] transition-all">
                        <div>
            ...
            {/* Filters */}
            <div className="bg-white p-4 rounded-3xl border border-zinc-100 shadow-sm flex flex-col md:flex-row items-center gap-4">
                <div className="relative flex-1 group w-full">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-6 py-4 bg-zinc-50 border border-zinc-100 rounded-2xl text-xs font-bold text-[#1a1a1a] placeholder:text-zinc-300 outline-none focus:border-[#5593C3] transition-all"
                    />
                </div>
            ...
            <div className="bg-white rounded-[40px] border border-zinc-100 shadow-xl overflow-hidden">
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead className="bg-zinc-50 text-[#5593C3] text-[10px] font-black uppercase tracking-[0.2em] border-b border-zinc-100">
                            <tr>
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-5">
                                                {post.cover_image_url ? (
                                                    <img src={post.cover_image_url} alt="" className="w-16 h-16 rounded-2xl object-cover shadow-sm ring-4 ring-white" />
                                                ) : (
                                                    <div className="w-16 h-16 rounded-2xl bg-zinc-50 border border-zinc-100 flex items-center justify-center text-zinc-200">
                                                        <FileText className="w-8 h-8" />
                                                    </div>
                                                )}
                                                <div className="space-y-1">
                                                    <p className="font-black text-[#1a1a1a] group-hover:text-[#5593C3] transition-colors text-lg tracking-tight leading-tight uppercase truncate max-w-[200px]">
                                                        {post.title}
                                                    </p>
                                                    <div className="flex items-center gap-2">
                                                        <span className="text-[10px] font-mono font-black text-zinc-300">/{post.slug}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="flex items-center justify-center gap-6">
                                                <div className="text-center group-hover:scale-110 transition-transform">
                                                    <p className="text-[9px] font-black text-zinc-300 uppercase tracking-widest mb-0.5">Views</p>
                                                    <p className="text-xs font-black text-zinc-500 tabular-nums">{post.view_count}</p>
                                                </div>
                                                <div className="text-center group-hover:scale-110 transition-transform">
                                                    <p className="text-[9px] font-black text-zinc-300 uppercase tracking-widest mb-0.5">Likes</p>
                                                    <p className="text-xs font-black text-pink-500 tabular-nums">{post.like_count}</p>
                                                </div>
                                                <div className="text-center group-hover:scale-110 transition-transform">
                                                    <p className="text-[9px] font-black text-zinc-300 uppercase tracking-widest mb-0.5">Comm</p>
                                        ...
                                        <td className="px-8 py-6 text-right">
                                            <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-all">
                                                <Link
                                                    ...
                                                    className="p-3 text-zinc-400 hover:text-[#5593C3] hover:bg-blue-50 rounded-2xl transition-all"
                                                >
